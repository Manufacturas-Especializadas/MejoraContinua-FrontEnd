...
const MejoraForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${config.apiUrl}/ContinuousImprovementForm/Register`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      <div
        className="bg-white shadow rounded-lg p-6 max-w-2xl mx-auto w-full
                bg-gradient-to-br from-indigo-50 to-blue-50 px-4"
      >
        <div
          className="bg-white shadow-xl rounded-lg p-6 md:p-8 w-full max-w-2xl
        ...
        >
          ...
          {step === 3 && (
            <Paso3Mejora formData={formData} handleChange={handleChange} />
          )}
