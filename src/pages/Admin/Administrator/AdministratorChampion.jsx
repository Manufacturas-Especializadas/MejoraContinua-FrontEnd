...
const AdministratorChampion = () => {
    ...
    const getChampionList = async () => {
      try {
        const response = await fetch(
          `${config.apiUrl}/ContinuousImprovementForm/GetListChampions`
        );
  ...
  useEffect(() => {
    const getIdeaById = async () => {
      try {
        const response = await fetch(
          `${config.apiUrl}/ContinuousImprovementForm/GetIdeaById?id=${id}`
        );
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(
        `${config.apiUrl}/ContinuousImprovementForm/AssignChampionsToIdea`,
        {
          method: "POST",
          headers: {
    ...
    <>
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="space-y-6">
          ...
          <h2 className="text-center text-gray-700">Elige a un champion</h2>
